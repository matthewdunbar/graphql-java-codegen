...
/**
 * Class having only Scala-specific methods for code-generation Most of the
 * logic is still residing in the parent class
 */
public class ScalaGraphQLCodegen extends GraphQLCodegen {
	...
	protected void initCustomTypeMappings(Collection<ExtendedScalarTypeDefinition> scalarTypeDefinitions) {
		// Although Scala doesn't work like kotlin`?`, But for primitive types that
		// allow nulls, we can use Option.
